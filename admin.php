...
<body>
        ...
        <li class="nav-item">   
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <li>
                        <a class="dropdown-item" href="admin.php?page=profil">Profile 
                            <?= $_SESSION['username']?>
                        </a>
                    </li>
    ...
    <div>
        <a href="https://www.instagram.com/rakhakea?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="><i class="bi bi-instagram h2 p-2 text-dark"></i></a>
        <a href="https://x.com/keanuraa"><i class="bi bi-twitter-x h2 p-2 text-dark"></i></a>
        <a href="https://wa.me/+6287882288516"><i class="bi bi-whatsapp h2 p-2 text-dark"></i></a> 
    </div>
    <div>Muhammad Rakha Keanura &copy; 2024</div>
    </footer>
    <!-- footer end -->
    <script
